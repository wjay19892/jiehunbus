...
function get_client_ip() {
	   ...
	   }else if ($_SERVER['HTTP_CLIENTIP'] && strcasecmp($_SERVER['HTTP_CLIENTIP'], "unknown")){
...
function h($text, $tags = null){
	...
	while(preg_match('/(<[^><]+)( lang|action|codebase|dynsrc|lowsrc)[^><]+/i',$text,$mat)){
	...
	//过滤多余html
	$text	=	preg_replace('/<\/?(html|head|meta|link|base|basefont|body|bgsound|title|style|script|form|iframe|frame|frameset|applet|id|ilayer|layer|name|script|xml)[^><]*>/i','',$text);
	//过滤合法的html标签
