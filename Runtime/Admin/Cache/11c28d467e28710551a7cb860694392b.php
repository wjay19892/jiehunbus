   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			...
			<th width="80" orderField="min" <?php if($_REQUEST["_order"] == 'min'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>最小价格</th>
			<th width="80" orderField="max" <?php if($_REQUEST["_order"] == 'max'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>最大价格</th>
