...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			...
			<li>
				<label><?php echo C("sysconfig.site_credits_name");?>：</label>
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			...
			<th width="200" orderField="val" <?php if($_REQUEST["_order"] == 'val'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>><?php echo C("sysconfig.site_credits_name");?></th>
			<th width="600">内容</th>
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getValueContent($vo['content'])); ?></td>
