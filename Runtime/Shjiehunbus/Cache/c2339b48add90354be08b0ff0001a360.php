...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>会员名：</label>
				<input name="uid" type="hidden" group="member" field="id"/>
				<input name="name" type="text" readonly="readonly" group="member" field="name"/>
				<a class="btnLook" href="<?php echo U('Member/lookUp/group/member');?>" target="dialog" rel="goods_lookup">查找带回</a>
			</li>
			<li>
				<label>评论者：</label>
				<input type="hidden" name="reviewer" group="member1" field="id">
