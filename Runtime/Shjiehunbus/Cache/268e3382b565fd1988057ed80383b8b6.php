...
<div class="pageContent">
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="600" orderField="uid" <?php if($_REQUEST["_order"] == 'uid'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>会员</th>
			<th width="200" orderField="ip" <?php if($_REQUEST["_order"] == 'ip'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>IP</th>
			<th width="200" orderField="address" <?php if($_REQUEST["_order"] == 'address'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>真实地址</th>
			<th width="200" orderField="addtime" <?php if($_REQUEST["_order"] == 'addtime'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>登录时间</th>
			<th width="80">操作</th>
		</tr>
		</thead>
		<tbody>
