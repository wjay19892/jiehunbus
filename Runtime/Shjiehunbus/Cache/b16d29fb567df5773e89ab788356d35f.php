...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="__URL__/add" target="dialog" rel="__MODULE___add" width="650" height="490"><span>新增</span></a></li>
			...
			<li><a class="edit" href="__URL__/edit/id/{sid_node}" target="dialog" rel="__MODULE___edit" warn="请选择" width="650" height="490"><span>修改</span></a></li>
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="520" orderField="title" <?php if($_REQUEST["_order"] == 'title'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>标题</th>
			<th width="80">所属分类</th>
			<th width="80">所属地区</th>
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
				...
				<td><?php echo (getParent('Goods_category',$vo['cid'])); ?></td>
				<td><?php echo (getParent('Region',$vo['rid'])); ?></td>
				<td>
				...
				<td><?php echo (showStatus($vo['status'],$vo['id'])); ?> <a href="__URL__/edit/id/<?php echo ($vo['id']); ?>" target="dialog" rel="__MODULE___edit" width="650" height="490">编辑</a> <a href="__ROOT__/index.php/Goods/view/id/<?php echo ($vo['id']); ?>" target="_blank" >预览</a></td>
