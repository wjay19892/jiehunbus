...
<div class="pageContent">
   ...
   <!-- 功能操作区域结束 -->
	<table class="table" width="100%" layoutH="138">
		...
		<tr>
			<th width="60">编号</th>
			<th width="800" orderField="name" <?php if($_REQUEST["_order"] == 'name'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>级别名称</th>
			<th width="80" orderField="min" <?php if($_REQUEST["_order"] == 'min'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>最小<?php echo C("sysconfig.site_credits_name");?></th>
			<th width="80" orderField="max" <?php if($_REQUEST["_order"] == 'max'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>最大<?php echo C("sysconfig.site_credits_name");?></th>
