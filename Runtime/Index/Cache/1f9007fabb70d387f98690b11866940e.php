            	...
            	<div class="pd10 clearfix">
                  ...
                  <div class="filled_big star_<?php echo ($evaluate_data["total"]["star"]); ?>"></div>
                        ...
                        <div class="price">
                            ...
                            <span><?php if(($data["payment"])  ==  "0"): ?><?php echo L("goods_index_payment_price");?><?php else: ?><?php echo L("goods_index_payment_deposit");?><?php endif; ?>&yen;<?php echo ($data["price"]); ?></span><br />
                        </div>
                        <div class="price_bot clearfix">
                            ...
                            <div class="price_purchase jvf_fl"><a class="jvf_allimg jvf_over" href="<?php echo U('Goods/buy/id/'.$data['id']);?>"><?php echo L("goods_index_buy_button");?></a></div>
                        </div>
                    </div>
...
<!-- Baidu Button END -->
            ...
            <form id="talk_aboutBox">
           		<div class="jvf_sendcnt_tit"><?php echo L("goods_index_jvf_sendcnt_tit");?></div>
