...
<script>
$(function(){
	memberAccount("<?php echo ($_REQUEST['item']); ?>");
});
</script>
...
<div class="detail_bot jvf_allimg"></div>
 <!--发表感受-->
      			<div class="extension_top">
                	<ul class="clearfix">
                        <li class="selected"><a href="javascript:;"><?php echo L("my_account");?></a></li>
                        <!--<li><a href="<?php echo U('Member/mycoupons');?>" get="get"><?php echo L("my_coupons");?></a></li>-->
                        <!--<li><a href="<?php echo U('Member/cashlogs');?>" get="get"><?php echo L("account_log");?></a></li>
                        <li><a href="<?php echo U('Member/rechargeList');?>" get="get"><?php echo L("recharge_log");?></a></li>
                        <li><a href="<?php echo U('Member/withdraw_log');?>" get="get"><?php echo L("withdraw_log");?></a></li>-->
                        <li><a href="<?php echo U('Member/valueLog');?>" get="get"><?php echo L("integral_log");?></a></li>
                    </ul>
                </div>
                
                <div class="jvf_account_box">
                	<div class="jvf_account_item jvf_account">
                		<div class="jvf_account1">	
		                	<div class="jvf_allimg acclin"></div>
		                	<ul class="clearfix">
		                    	<!--<li>
		                        	<div class="jvf_zhxx"></div>
		                        	<div class="zhxx_wz"><?php echo L("account_balance");?>:<?php echo ($memberdata["cash"]); ?></div>
		                            <div class="jvf_center">
		                                <span><a href="<?php echo U('Member/recharge');?>" id="recharge"><?php echo L("online_recharge");?></a></span>
		                                <span>|</span>
		                                <span><a href="<?php echo U('Member/prepaidCard');?>"><?php echo C("sysconfig.site_prepaid_card_name");?></a></span>
		                                <span>|</span>
		                                <span><a href="<?php echo U('Member/withdraw');?>" id="recharge"><?php echo L("withdraw");?></a></span>                
		                    		</div>
		                        </li>-->
		                        <li>
		                        	<div class="jvf_zhxx zhjf_bg"></div>
		                        	<div class="zhxx_wz"><?php echo C("sysconfig.site_credits_name");?>：<?php echo ($memberdata["value"]); ?></div>
		                            <div><a href="javascript:;" id="value_log"><?php echo C("sysconfig.site_credits_name");?><?php echo L("log_text");?></a></div>
		                        </li>
		                        <li>
		                        	<div class="jvf_zhxx zhdj_bg "></div>
		                        	<div class="zhxx_wz"><?php echo L("level_text");?>：<?php echo ($memberdata["level"]["name"]); ?></div>
		                            <div><a href="<?php echo U('Member/levelList');?>" id="level_list"><?php echo L("level_list");?></a></div>
		                        </li>
		                    </ul>
		                </div>
                	</div>
                    <!--我的优惠券-->
                	<div class="jvf_account_item" style="display:none;"></div>
                    <!--我的优惠券——end-->
                    <!--账户日志-->
                	<div class="jvf_account_item" style="display:none; padding:10px;"></div>
                    <!--账户日志——end-->
                    <!--充值日志-->
                	<div class="jvf_account_item" style="display:none; padding:10px;"></div>
                    <!--充值日志——end-->
