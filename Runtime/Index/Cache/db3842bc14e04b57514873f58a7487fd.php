...
<script>
$(function(){
	memberListings(<?php echo json_encode($_REQUEST);?>);
});
</script>
...
<div class="detail_bot jvf_allimg"></div>
 <!--发表感受-->
      			<div class="extension_top">
                	<ul class="clearfix">
                    	<li class="selected"><a href="<?php echo U('Circle/ajaxCircle/wasAttention/'.$memberdata['id']);?>"><?php echo L("my_listen");?></a></li>
                        <li><a href="<?php echo U('Circle/ajaxCircle/attention/'.$memberdata['id']);?>" get="get"><?php echo L("my_audience");?></a></li>
                        <li><a href="<?php echo U('Circle/ajaxCircle/at/my');?>" get="get"><?php echo L("mention_my");?></a></li>
                        <li><a href="<?php echo U('Circle/ajaxCircle/like/my');?>" get="get"><?php echo L("my_likes");?></a></li>
                        <?php if(C('sysconfig.is_open_chat') == 1){ ?>
                        <li><a href="<?php echo U('Member/chatLog');?>" get="get"><?php echo L("chat_log");?></a></li>
                        <?php } ?>
                    </ul>
                </div>
                <div class="clearfix listings_box">
                	<div class="listings_item"></div>
                	<div class="listings_item" style="display:none;"></div>
                    <div class="listings_item" style="display:none;"></div>
                    <div class="listings_item" style="display:none;"></div>
                	<?php if(C('sysconfig.is_open_chat') == 1){ ?>
                	<div class="listings_item" style="display:none;"></div>
