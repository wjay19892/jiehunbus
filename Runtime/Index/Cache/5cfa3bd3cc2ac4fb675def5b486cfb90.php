...
<script>
$(function(){
	memberIndex("<?php echo ($_REQUEST['item']); ?>");
});
</script>
...
<div class="jvf_frame detail_left_con clearfix">
	<div class="jvf_sendcnt_tit"><?php echo L("jvf_sendcnt_tit");?></div>
...
<div class="detail_bot jvf_allimg"></div>
 <!--发表感受-->
             <div class="extension_top">
                	<ul class="clearfix">
                    	<li class="selected"><a href="<?php echo U('Circle/ajaxCircle/uid/'.$memberdata['id']);?>"><?php echo L("my_say");?></a></li>
                        <li><a href="<?php echo U('Member/reminds');?>" get="get"><?php echo L("my_remind");?></a></li>
                        <li><a href="<?php echo U('Member/trips');?>" get="get"><?php echo L("my_dynamic");?></a></li>
                        <li><a href="<?php echo U('Member/otherDynamic');?>" get="get"><?php echo L("friends_dynamic");?></a></li>
                        <li><a href="<?php echo U('Member/buyOrderList');?>" get="get"><?php echo L("purchase_order");?></a></li>
                    </ul>
                </div>
                <div class="jvf_member_box">
                    <div class="jvf_member_item" style="display:block;"></div>
                    <div class="jvf_member_item jvf_remind"></div>
                    <div class="jvf_member_item"></div>
                    <div class="jvf_member_item"></div>
                    <!--购买订单-->
                    <div class="jvf_member_item"  style="padding:10px;"></div>
                    <!--购买订单——end-->
                </div>
                <div class="jvf_all_page" style="display:none;">
                	<div class="jvf_page" ></div>
				</div>
                </div>      	
            </div>
       </div>
