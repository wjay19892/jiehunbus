...
<script>
$(function(){
	memberEdit("<?php echo ($_REQUEST['item']); ?>");
});
</script>
...
<div class="detail_bot jvf_allimg"></div>
 <!--发表感受-->
      			<div class="extension_top">
                	<ul class="clearfix">
                        <li class="selected"><a href="javascript:;"><?php echo L("my_profile");?></a></li>
                        <li><a href="javascript:;"><?php echo L("user_space_avatar");?></a></li>
                        <li><a href="<?php echo U('Member/location');?>" get="get"><?php echo L("common_position_setting");?></a></li>
                        <li><a href="<?php echo U('Member/verification');?>" get="get"><?php echo L("authentication_account");?></a></li>
                        <li><a href="<?php echo U('Member/privacy');?>" get="get"><?php echo L("privacy_settings");?></a></li>
                        <li><a href="<?php echo U('Member/modifyPwd');?>" get="get"><?php echo L("change_password");?></a></li>
                    </ul>
                </div>
                
                <div class="jvf_edit_box">
                	<div class="jvf_edit_item jvf_edit">
                	<form method="post" id="updateform" enctype="multipart/form-data" action="<?php echo U('Member/update');?>">
                	<div style="display: none;"><input name="useless" type="file"></div>
                	<div class="top">
              			<h2><span class="edit_room_icon complete"></span><?php echo L("basic_info");?></h2>
           			</div>
                    <ul>
                    	<li class="bder_topno"><label for="user_name"><?php echo L("username_text");?>:</label>
                        	<input type="text" name="name" size="30" value="<?php echo ($memberdata["name"]); ?>">
                        </li>
                        <li class="bder_topno"><label for="">性别：</label>
                        	<select class="jvf_sel" name="sex">
                                <option value="0" <?php if(($memberdata["sex"])  ==  "0"): ?>selected="selected"<?php endif; ?>>保密</option>
                                <option value="1" <?php if(($memberdata["sex"])  ==  "1"): ?>selected="selected"<?php endif; ?>>男</option>
                                <option value="2" <?php if(($memberdata["sex"])  ==  "2"): ?>selected="selected"<?php endif; ?>>女</option>
							</select>
                        </li>
                        <li><label for="user_email"><?php echo L("mail_text");?>:</label>
                        	<input type="text" name="mail" size="30" value="<?php echo ($memberdata["mail"]); ?>" id="user_email">
                            <div class="form_helper"><?php echo L("member_edit_form_helper");?></div>
                        </li>
                         <li><label for="user_phone"><?php echo L("phone_text");?>:</label>
                         <div class="phone-numbers-container">
                         <table cellspacing="0" cellpadding="0" class="phone-numbers-table">
	                        <tbody>
	                          <tr data-number="<?php echo ($memberdata["phone"]); ?>" class="verified">
	                            <th><?php echo ($memberdata["phone"]); ?></th>
	                            <td style="position:relative;"><?php if(($memberdata["phonestatus"])  ==  "1"): ?><span class="verified"><span class="icon"></span><?php echo L("verification_text");?></span><?php else: ?><span class="unverified"><a id="smsauthcode" class="jvf_addphone" href="javascript:void(0);"><?php echo L("verification_code_send");?></a></span><?php endif; ?></td>
	                          </tr>
	                        </tbody>
	                      </table>
                      	<a id="addphone" class="jvf_addphone" href="javascript:void(0);"><span class="icon"></span><?php echo L("member_edit_editphone");?></a>
                           </div>
                         <div class="jvf_cl"></div>
                         <div class="phoneBox" style="display: none;">
	                         <div class="form_helper"><?php echo L("member_edit_div_form_helper");?></div>
	                         <div class="phone-number-verify jvf_frame">
		                      <div class="pnaw-step1 clearfix">
		                          <p class="send-verification-error"></p>
		                          <p><?php echo L("verification_code_input_phone");?></p>
		                          <label for="phone_number"><?php echo L("phone_text");?>：</label>
		                          <input type="text" id="phone_number" name="phone_number"value="">
		                           <a id="smsphone" href="javascript:void(0);" class="btn linebl f12 p115"><?php echo L("verification_code_send");?></a>
		                      </div>
		                      <div class="pnaw-step2 clearfix">
		                        <p class="pnaw-verification-error"></p>
		                        <p><?php echo L("verification_code_sended");?></p>
		                        <label for="phone_number_verification"><?php echo L("verification_code");?>：</label>
		                        <input type="text" id="phone_authcode" name="authcode" value="">
		                        <a id="verifyphone" href="javascript:void(0);" class="btn linebl f12 p115"> <?php echo L("verification_text");?> </a> 
		                      </div>
	                        </div>
	                    </div>
                        </li>
                         <li><label for="user_address"><?php echo L("member_edit_user_address");?>:</label>
                        	<input type="text" name="address" size="30" value="<?php echo ($memberdata["address"]); ?>" placeholder="<?php echo L("member_edit_user_address");?>" id="user_address">
                        </li>
                        <li><label for="user_self_introduction"><?php echo L("member_edit_user_self_introduction");?>:</label>
                        	<textarea name="content" autocomplete="off" tabindex="1" rows="8" id="user_self_introduction"><?php echo ($memberdata["self_introduction"]); ?></textarea>
                            <div class="form_helper"><?php echo L("member_edit_div");?></div>
                        </li>
                    </ul>
                    <div class="top" style="border-top:solid 1px #ccc;">
              			<h2><span class="edit_room_icon complete"></span><?php echo L("member_edit_help");?></h2>
           			</div>
                     <ul>
                        <?php if(is_array($mattlist)): $i = 0; $__LIST__ = $mattlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$att): ++$i;$mod = ($i % 2 )?><li class="bder_topno clearfix">
			                    <label for="user_att<?php echo ($att["id"]); ?>"><?php echo ($att["key"]); ?></label>
			                    <?php if($att['type'] == 0): ?><!-- 手动输入 -->
			                        <input id="user_att<?php echo ($att["id"]); ?>" type="text" name="<?php echo ($att["id"]); ?>" size="30" value="<?php echo ($att["val"]); ?>" /><?php endif; ?>
			                    
			                    <?php if($att['type'] == 1): ?><?php if(is_array($att['enum'])): foreach($att['enum'] as $key=>$enum_item): ?><!-- 单选 -->
			                        <input id="user_att<?php echo ($att["id"]); ?>" type="radio" name="<?php echo ($att["id"]); ?>" value="<?php echo ($enum_item); ?>" class="mtradio" <?php if(($enum_item == $att['val']) OR (empty($att['val']) AND ($enum_item == $att['default'])) ): ?>checked="checked"<?php endif; ?> /><?php echo ($enum_item); ?><?php endforeach; endif; ?><?php endif; ?>
			                    
			                    <?php if($att['type'] == 2): ?><select class="jvf_inputb" id="user_att<?php echo ($att["id"]); ?>" name="<?php echo ($att["id"]); ?>">
			                            <?php if(is_array($att['enum'])): foreach($att['enum'] as $key=>$enum_item): ?><!-- 下拉 -->
			                            <option value="<?php echo ($enum_item); ?>" <?php if(($enum_item == $att['val']) OR (empty($att['val']) AND ($enum_item == $att['default'])) ): ?>selected="selected"<?php endif; ?>><?php echo ($enum_item); ?></option><?php endforeach; endif; ?>
			                        </select><?php endif; ?>
			                    
			                    <?php if($att['type'] == 3): ?><!-- 文本域 -->
			                        <textarea id="user_att<?php echo ($att["id"]); ?>" cols="40" name="<?php echo ($att["id"]); ?>"><?php echo ($att['val']); ?></textarea><?php endif; ?>
			                    
			                    <?php if($att['type'] == 4): ?><div class="lnh17 clearfix jvf_fl" style="width:570px;">
			                        <?php if(is_array($att["enum"])): $k = 0; $__LIST__ = $att["enum"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$enum_item): ++$k;$mod = ($k % 2 )?><!-- 多选 -->
			                        <div class="jvf_fl" style="margin-bottom:5px;">
			                        <input class="jvf_fl edit_checkbox" id="user_att<?php echo ($att["id"]); ?><?php echo ($k); ?>" type="checkbox" name="<?php echo ($att["id"]); ?>[]" value="<?php echo ($enum_item); ?>" <?php if(in_array($enum_item,$att['val']) OR (empty($att['val']) AND ($enum_item == $att['default'])) ): ?>checked="checked"<?php endif; ?> /><label class="jvf_la jvf_fl edit_label" for="user_att<?php echo ($att["id"]); ?><?php echo ($k); ?>"><?php echo ($enum_item); ?></label>
			                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
			                         <div class="jvf_cl"></div>
			                    <div><?php endif; ?>     
			                                                   
			                    <?php if($att['type'] == 5): ?><!-- 图片域 -->
			                        <input id="user_att<?php echo ($att["id"]); ?>" type="file"  name="<?php echo ($att["id"]); ?>" class="mtfile" /> 
			                        <?php if($att['val'] != ''): ?><div class="form_helper"><img src="__ROOT__<?php echo ($att["val"]); ?>" alt="<?php echo ($att["key"]); ?>"></div><?php endif; ?><?php endif; ?>
			                    
			                    <?php if($att['type'] == 6): ?><!-- 日历控件 -->
			                        <input id="user_att<?php echo ($att["id"]); ?>" class="jvf_date mttime" type="text" readonly="true" size="25" name="<?php echo ($att["id"]); ?>" value="<?php echo ($att['val']); ?>">
			                        <script>
									$(function() {
										$( "#user_att<?php echo ($att["id"]); ?>" ).datepicker({changeMonth: true,changeYear: true,shortYearCutoff: 50});
									});
								    </script><?php endif; ?>
			                    
			                    <?php if($att['type'] == 7): ?><!-- 编辑器 -->
			                        <div class="lnh22 clearfix">
			                        <textarea id="user_att<?php echo ($att["id"]); ?>" class="editor" name="<?php echo ($att["id"]); ?>" upImgUrl="<?php echo U('Xheditor/upLoadImg');?>" upImgExt="jpg,jpeg,gif,png" cols="40"rows="8" ><?php echo ($att["val"]); ?></textarea>
			                        </div><?php endif; ?>
			                    <div class="form_helper"><?php echo ($att["explain"]); ?></div>
			                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                     </ul>
                     </form>
                     <div class="jvf_box_buttom">
                    	<span class="jvf_mgf"><a class="btn p2153 f20 jvf_bold" href="javascript:;" id="updateSubmit"><?php echo L("member_edit_submit");?></a></span>
                    </div>
                	</div>
                    <!--编辑头像-->
                	<div class="jvf_edit_item jvf_edit_head" style="display:none;">
                		<div class="edit_head_top clearfix">
     <h2> <span class="edit_icon jvf_mbpng jvf_fl"></span>
         <p class="jvf_fl"><?php echo L("member_avatar_p");?></p>
         <div class="jvf_fl"><?php echo L("member_avatar_div_before");?><?php echo C("sysconfig.site_name");?><?php echo L("member_avatar_div_after");?></div>
     </h2>
 </div>
 <div class="edit_head_con clearfix">
 	<div class="edit_left jvf_fl">
     	<div class="edit_img jvf_fl edit_bimg"><img src="<?php echo ($memberdata["header"]["path"]); ?>" /></div>
         <div class="edit_img jvf_fl edit_simg"><img src="<?php echo ($memberdata["header"]["thumbnail"]); ?>" /></div>
     </div>
     
     <div class="edit_right jvf_fr clearfix">
     	<div class="edit_show phot_bg">
         	<div class="show_t"><?php echo L("member_avatar_h3_span");?></div>
         	<form name="avatar_upload_form" method="post" id="avatar_upload_form" enctype="multipart/form-data" action="<?php echo U('Avatar/avatar_upload');?>" style="display:none;">
              <input type="file" name="header_pic" id="user_header_pic">
            </form>
             <div class="phot_bg show_img"></div>
         </div>
         <div class="up_img clearfix">
         	<div class="jvf_fl ima">
                 <div class=" im up_img1 phot_bg"><a class="phot_bg" href="javascript:;" id="cam"></a></div>
                 <span><?php echo L("member_avatar_span");?></span>
             </div>
             <div class="jvf_fl ima">
                 <div class="im up_img2 phot_bg"><a class="phot_bg" href="javascript:;" id="up"></a></div>
                 <span><?php echo L("member_avatar_li_span");?></span>
             </div>
         </div>
     </div>
