<?php if (!defined('THINK_PATH')) exit();?><?php if(is_array($goodsdata)): $i = 0; $__LIST__ = $goodsdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="shop_all">
     <div class="jvf_frame w225">
         <div class="shopall_img"><a href="<?php echo U('Goods/index/id/'.$vo['id']);?>"><img width="213" src="<?php echo ($vo["accessory"]["thumbnail"]); ?>" height="<?php echo ($vo["accessory"]["thumbnail_height"]); ?>"></a></div>
