...
<script>
$(function(){
	circleIndex(<?php echo ($condition); ?>);
});
</script>
<!----搜索开始---->

<form id="searchForm" action="<?php echo U('Circle/index');?>" method="get">
<div id="car_top2" class="clearfix">
    <div id="main_box">

        <div id="select_box">
            <div class="searchbg"> 
                <input class="search_sp2" type="text" placeholder="输入您想要知道的信息" name="search_key">
                <div class="searchbg2">
...
<div class="mainbody body_bot body_con clearfix" style="padding:0px 0 20px;">
	<div class="jvf_body">
       <div class="category_shop clearfix" style="margin-top:0px;">
                <div class="shop_all">
                    <div class="jvf_frame w225">
                    	<div class="circle clearfix">
                    	<?php if(is_array($circledata)): $i = 0; $__LIST__ = $circledata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="circle_list">
                                <div class="circle_title"><?php echo ($vo["name"]); ?></div>
                                <ul class="clearfix">
                                <?php $label = explode(',', $vo['label']);
                                	$lids = explode(',', $vo['lids']); ?>
                                <?php if(is_array($label)): $i = 0; $__LIST__ = $label;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): ++$i;$mod = ($i % 2 )?><li><a href="javascript:;" lid="<?php echo ($lids[$key]); ?>"><?php echo ($v); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
