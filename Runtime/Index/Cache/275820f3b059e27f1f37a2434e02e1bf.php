...
<script>
$(function(){
    var mp=<?php echo ($minprice1); ?>;
    var fenggeid=<?php echo ($fenggeid); ?>;
    if(mp!=-1){
        $('.category_f li a').removeClass('fontbold');
        $('.category_f li a[min="<?php echo ($minprice1); ?>"]').addClass('fontbold'); 
    }
    if(fenggeid!=-1){
        $('.category_j li a').removeClass('fontbold');
        $('.category_j li a[cid="<?php echo ($fenggeid); ?>"]').addClass('fontbold');
    }
    
	searchIndex(<?php echo ($condition); ?>);
    $('.category_f li a[min="<?php echo ($minprice1); ?>"]').click();
    $('.category_j li a[cid="<?php echo ($fenggeid); ?>"]').click();
...
<div id="car_top2" class="clearfix">
    <div id="main_box">
        ...
        <div id="select_box">
            <div class="searchbg"> 
                <input class="search_sp2" type="text" placeholder="输入商品名搜索" name="search_key">
                <div class="searchbg2">
...
<div class="mainbody body_bot body_con clearfix" style="padding:0px 0 20px;">
	<div class="jvf_body">
		<div class="category">
        	<div class="category_j bod_bot clearfix">
            	<span class="category_th"><?php echo L("category_text");?>：</span>
                <ul class="clearfix">
                	<li><a class="fontbold" href="javascript:;" cid="0"><?php echo L("all_text");?></a></li>
                	<?php if(is_array($categorydata)): $i = 0; $__LIST__ = $categorydata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><a href="javascript:;" cid="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>(<?php echo ($vo["count"]); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="jvf_cl"></div>
                <ul class="category_sun" style="display:none">
                
                </ul>
            </div>
            <div class="category_v bod_bot clearfix">
            	<span class="category_th"><?php echo L("region_text");?>：</span>
                <ul class="clearfix">
                	<li><a class="fontbold" href="javascript:;" rid="0"><?php echo L("all_text");?></a></li>
                	<?php if(is_array($regiondata)): $i = 0; $__LIST__ = $regiondata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><a href="javascript:;" rid="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>(<?php echo ($vo["count"]); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <div class="category_f bod_bot clearfix">
            	<span class="category_th"><?php echo L("price_text");?>：</span>
                <ul class="clearfix">
                	<li><a class="fontbold" href="javascript:;" min="0" max="0"><?php echo L("all_text");?></a></li>
                	<?php if(is_array($price_rangedata)): $i = 0; $__LIST__ = $price_rangedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><a href="javascript:;" min="<?php echo ($vo["min"]); ?>" max="<?php echo ($vo["max"]); ?>"><?php echo ($vo["name"]); ?>(<?php echo ($vo["count"]); ?>)</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <div class="category_n clearfix">
            	<span class="category_th"><?php echo L("distance");?>：</span>
                <ul class="clearfix">
                	<li><a class="fontbold" href="javascript:;" min="0" max="0"><?php echo L("all_text");?></a></li>
                	<?php if(is_array($distance_rangedata)): $i = 0; $__LIST__ = $distance_rangedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li><a href="javascript:;" min="<?php echo ($vo["min"]); ?>" max="<?php echo ($vo["max"]); ?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
        ...
        <div class="shop_nav clearfix">
        	<ul class="nav_left jvf_fl">
            	<li><a class="fontbold" href="javascript:;" rel="all"><?php echo L("all_goods");?></a></li>
            	<li><a href="javascript:;" rel="new"><?php echo L("new_goods");?></a></li>
            </ul>
