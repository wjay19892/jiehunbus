...
<div class="detail_bot jvf_allimg"></div>
 <!--发表感受-->
      			<div class="extension_top">
                	<ul class="clearfix">
                        <li class="selected"><a href="javascript:;"><?php echo L("member_goods_mbtit");?></a></li>
                        <!--<li><a href="<?php echo U('Member/sellOrderList');?>" get="get"><?php echo L("sell_order");?></a></li>
                        <li><a href="<?php echo U('Member/sellcoupons');?>" get="get"><?php echo L("site_couponname_list");?></a></li>
                        <li><a href="<?php echo U('Member/verifycoupon');?>" get="get"><?php echo L("consumer_registration");?></a></li>-->
                        <li><a href="<?php echo U('Member/businessInvitation');?>" get="get"><?php echo L("recommend_management");?></a></li>
                        <li><a href="<?php echo U('Member/incomeEvaluation');?>" get="get"><?php echo L("member_reviews_get");?></a></li>
                    </ul>
                </div>
                <div class="jvf_goods_box">
                	<div class="jvf_goods_item jvf_goods">
                		<table cellspacing="0" cellpadding="0" border="0" class="trips_list jvf_mbwid">
					          <thead>
					            <tr>
					              <th class="t_c_good"><?php echo L("goods_title");?></th>
					              <th class="t_c_pw"><?php echo L("price_text");?></th>
					              <!--<th class="t_c_data"><?php echo L("member_goods_t_c_data");?></th>-->
					              <th class="t_c_operate"><?php echo L("operational_text");?></th>
					            </tr>
					          </thead>
					          <tbody>
					          <?php if(is_array($goodsdata)): $i = 0; $__LIST__ = $goodsdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
					              <td>
					                <span>
					                  <a class="shpc" target="_blank" href="<?php echo U('Goods/index/id/'.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
					                  <?php if($vo["audit"] == 0): ?><?php if($vo["status"] == 1): ?>(<?php echo L("ing_status");?>)<?php else: ?>(<?php echo L("over_status");?>)<?php endif; ?>
					                  <?php else: ?>
					                  	<span style="color: red;">(<?php echo L("ing_audit");?>)</span><?php endif; ?>
                  					</span>
					              </td>
					              <td align="center"><span><?php echo L("unit_price");?>：<b class="weic">&yen;<?php echo ($vo["price"]); ?></b><!--<br>
					                  <?php echo L("required_pay");?><?php if(($vo["payment"])  ==  "1"): ?><?php echo L("payment_deposit");?>：<b style="font-weight:bold; color:#FF0000;">&yen;<?php echo ($vo["price"]); ?></b><?php else: ?><?php echo L("payment_price");?><?php endif; ?></span></td>
					              <!--<td class="txc"><span><?php echo ($vo["crrnum"]); ?></span>--></td>
					              <td class="txc">
					              		<?php if($vo["audit"] == 0): ?><a class="reject gooddetail" href="<?php echo U('Member/gooddetail/id/'.$vo['id']);?>">[<?php echo L("detail_text");?>]</a>
						               <!-- <a class="reject" href="<?php echo U('Member/downcoupons/id/'.$vo['id']);?>">[<?php echo L("member_goods_down");?>]</a>-->
						               <?php else: ?>
						                <a class="reject" href="<?php echo U('Goods/view/id/'.$vo['id']);?>">[<?php echo L("goods_release_view");?>]</a>
						               	<a class="reject" href="<?php echo U('Goods/release/id/'.$vo['id']);?>" target="_blank">[<?php echo L("edit");?>]</a>
						                <a class="reject delGoods" href="<?php echo U('Member/delGoods/id/'.$vo['id']);?>">[<?php echo L("delete");?>]</a><?php endif; ?>
					              </td>
                    ...
                    <!--卖出订单-->
                	<div class="jvf_goods_item" style="display:none; padding:10px;"></div>
                    <!--卖出订单——end-->
                    <!--优惠券列表-->
                	<div class="jvf_goods_item" style="display:none;"></div>
                    <!--优惠券列表——end-->
                    <!--消费登记-->
                	<div class="jvf_goods_item" style="display:none;"></div>
                    <!--消费登记——end-->
