...
<div class="mainbody0 body_bot body_con clearfix">
	<div class="jvf_body">  
        ...
        <div class="mainbody_con clearfix">
            ...
            <div class="jvf_title">
                <h2><?php echo L("announcement");?><span><a target="_blank" href="<?php echo U('Article/lists/cid/2');?>"><?php echo L("more_text");?></a></span>
                </h2>
                <div class="mainbody_right_list">
                    ...
                    <?php if(is_array($announcement)): $i = 0; $__LIST__ = $announcement;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><li>
                            <a style="float:left;width:303px;overflow:hidden;" target="_blank" href="<?php echo U('Article/detail/id/'.$vo['id']);?>" ><?php echo ($vo["title"]); ?></a> 
                            <span style="float:right;padding-right:10px;"><?php echo (toDate($vo["addtime"])); ?></span>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
